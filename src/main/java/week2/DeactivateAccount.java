...
@Test
	...
	//	login(null, null, null);
		...
		type(locateElement("xpath", "//label[text()='Account ID:']/following::input[2]"),fName);
		type(locateElement("xpath", "//label[text()='Account ID:']/following::input"),AcId);
		...
		click(locateElement("link text", "Find Accounts"));
		type(locateElement("xpath", "//label[text()='Account ID:']/following::input[2]"),name);
		type(locateElement("xpath", "//label[text()='Account ID:']/following::input"),id);
		click(locateElement("xpath", "//button[text()='Find Accounts']"));
